...
public class MoveIn extends Transition {
    ...
    public void configure(LayerView layerView, Timeline timeline) {
        KeyValue xValue1 = new KeyValue(layerView.translateXProperty(), getOffScreenX(layerView), getInterpolator());
        KeyValue yValue1 = new KeyValue(layerView.translateYProperty(), getOffScreenY(layerView), getInterpolator());
        KeyValue xValue2 = new KeyValue(layerView.translateXProperty(), 0, getInterpolator());
        KeyValue yValue2 = new KeyValue(layerView.translateYProperty(), 0, getInterpolator());
